...
import { getRoleLabel, getRoleIcon, formatDateShort } from '@/lib/utils';

const ROLES = ['', 'worker', 'employer', 'freelancer', 'trainer', 'recruiter'];
            ...
            {filtered.map((profile) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">{getRoleLabel(profile.role)}</p>
                </div>
                {profile.bio && (
